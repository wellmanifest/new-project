...
- `001-anna-nowak-md2pdf`: `process = "md2pdf"`, `input = "in/cv.md"`, `output = "out/cv.pdf"`, `ok = true`
- `002-anna-nowak-pdf2md`: `process = "pdf2md"`, `input = "in/cv.pdf"`, `output = "out/cv.md"`, `ok = true`
