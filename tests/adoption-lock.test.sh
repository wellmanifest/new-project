...
assert lock['standard']['version'] == '0.13.2'
...
sed 's/"version": "0.13.2"/"version": "9.9.9"/' \
...
open(version_path, 'w', encoding='utf-8').write('0.13.3\n')
manifest = json.load(open(manifest_path, encoding='utf-8'))
manifest['standard']['version'] = '0.13.3'
...
lock = json.load(open(root / '.governance/manifest.lock.json', encoding='utf-8'))
assert manifest['standard']['version'] == '0.13.3'
...
grep -q '^up-to-date wellmanifest/new-project 0.13.3 ' "$fixture/upgraded-check.out"
