...
- [ ] [`ticket-077`](project/ticket-077/README.md) — powiązać raport agenta z
  ...
  koordynator odrzuca raport bez `workspaceRoot`. Stan: `BLOCKED / BLOCKED`;
  klasyfikacja: `FEATURE / P1 / requested`; workstream: `governance`.
  `placement` pozostaje opcjonalne na starych ticketach; `publication_authorized=false`; bez merge na `main`.
