...
- [ ] [`ticket-003`](project/ticket-003/README.md) — pogodzić dwa rozbieżne
  ...
  rezerwacje dla `PLAN/BLOCKED`. Stan: `BLOCKED / VALIDATION`; implementacja,
  lokalne testy i zdalne checki PR #1 przechodzą, ale finalny SHA wymaga
  niezależnego review. Zależny `todo2code` używa lokalnie `z-ai/glm-5.2`.
