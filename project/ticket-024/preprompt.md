# Preprompt & Wytyczne Techniczne (ticket-024)

- **Tytuł Zadania**: Strategia package-manifest dla pliku ktory target musi rozszerzyc
- **Utworzono**: 2026-08-05T11:51:11Z
...
- Przed pisaniem kodu przedstaw plan w `ai-claude.md` oraz w `TODO.md` do weryfikacji człowieka (`P-CORE-008`).
