# Preprompt & Wytyczne Techniczne (ticket-066)

- **Tytuł Zadania**: Canonical diagnostic solutions and publication lifecycle
- **Utworzono**: 2026-08-12T08:05:00Z
...
- Katalog diagnostyk: `governance/diagnostics.json`
- Allocator: `project/new-ticket.sh`
- Audyt lokalny: `scripts/workspace_lifecycle_check.py`
- Procedura publikacji: `CONTRIBUTING.md`, `C-PUBLISH-003`
...
- Rozwiązania wielokrotnego użytku zapisuj w katalogu `error/`, a nie w logu
  ticketu; każdy runbook musi zachować fail-closed semantics i wskazać
  deterministyczną weryfikację.
