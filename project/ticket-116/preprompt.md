# Preprompt & Wytyczne Techniczne (ticket-116)

- **Tytuł Zadania**: Document GOV-INTENT runbook in diagnostics
- **Utworzono**: 2026-08-24T11:27:09Z
...
- Na tej podstawie zbuduj specyfikację wykonawczą w pliku `ai-antigravity.md` (rozumienie intencji, zakres prac, koncepcja, Kryteria Odbioru).
- Przed pisaniem kodu zapisz plan w `ai-antigravity.md`, `TODO.md` i
