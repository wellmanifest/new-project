# Preprompt & Wytyczne Techniczne (ticket-083)

- **Tytuł Zadania**: Recognize generated secret placeholders safely
- **Utworzono**: 2026-08-14T19:46:25Z
...
- Specyfikacja modułu: `scripts/governance_check.py`, funkcja
  `probable_secret_fields`; regresje: `tests/governance-validator.test.sh`.
