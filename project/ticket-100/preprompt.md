# Preprompt & Wytyczne Techniczne (ticket-100)

- **Tytuł Zadania**: Treat generated artifact receipts as governance carriers
- **Utworzono**: 2026-08-21T17:34:39Z
...
- Specyfikacja modułu: `governance/manifest.default.json`,
  `.githooks/pre-commit`, `tests/governance-validator.test.sh`
