# Preprompt & Wytyczne Techniczne (ticket-022)

- **Tytuł Zadania**: Canonical change evaluation runtime
- **Utworzono**: 2026-08-05T11:26:26Z
...
- Specyfikacja modułu: `CONTRIBUTING.md`, sekcja `CHANGE EVALUATION`
...
- Nie dodawaj zależności runtime ani zaufania do wyniku LLM.
- Nie wykonuj tekstu DSL; mapuj wersjonowane reguły na zamknięte,
  deterministyczne kontrole.
- Każdy raport musi być związany z dokładnym changesetem i hashami kontraktu.
