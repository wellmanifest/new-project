# Preprompt & Wytyczne Techniczne (ticket-076)

- **Tytuł Zadania**: Authorize protected Validator delivery without redundant prompts
- **Utworzono**: 2026-08-14T13:08:48Z
...
- Osobnej władzy wymagają destrukcja, sekrety, nowa koordynacja zewnętrzna
  oraz materialnie nowy cel. W ramach autoryzowanego outcome agent może
  uruchomić zadeklarowany chroniony proces dostawy bez ponownego pytania;
  dopiero niezależny exact-head approval tego procesu jest trusted merge
  evidence. Sama autoryzacja sesji nigdy nie jest takim dowodem.
