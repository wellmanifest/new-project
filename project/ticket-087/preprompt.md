# Preprompt & Wytyczne Techniczne (ticket-087)

- **Tytuł Zadania**: Mandate agents invoke validator-agent for trusted merge approval
- **Utworzono**: 2026-08-15T19:36:41Z
...
- Na tej podstawie zbuduj specyfikację wykonawczą w pliku `ai-composer.md` (rozumienie intencji, zakres prac, koncepcja, Kryteria Odbioru).
- Przed pisaniem kodu zapisz plan w `ai-composer.md`, `TODO.md` i
