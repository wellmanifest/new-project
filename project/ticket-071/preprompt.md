# Preprompt & Wytyczne Techniczne (ticket-071)

- **Tytuł Zadania**: Detect orphaned local branches in terminal workspace audits
- **Utworzono**: 2026-08-12T15:50:26Z
...
- Lokalny checker: `scripts/workspace_lifecycle_check.py`
- Test kontraktowy: `tests/workspace-lifecycle.test.sh`
- Katalog diagnostyk: `governance/diagnostics.json`
- Runbook: `error/GOV-WORKSPACE-LIFECYCLE.md`
- Reguły: `P-WORKSPACE-001`–`004`, `C-WORKSPACE-001`–`004`
