# Preprompt & Wytyczne Techniczne (ticket-053)

- **Tytuł Zadania**: Keep managed Python lint-neutral downstream
- **Utworzono**: 2026-08-11T18:52:21Z
...
- Manifest pakietu: `governance/package-manifest.json`
- Źródła zarządzane: `scripts/check_required_checks.py`,
  `scripts/decision_record.py`, `scripts/governance_check.py`
- Regresja downstream: lokalny pilot `semcod/code2docs`, gdzie `.governance`
  wprowadza dokładnie 17 nowych błędów Ruffa.
