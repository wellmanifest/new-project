# Preprompt & Wytyczne Techniczne (ticket-115)

- **Tytuł Zadania**: fix windows pre-commit executable check
- **Utworzono**: 2026-08-23T12:57:25Z
...
- Na tej podstawie zbuduj specyfikację wykonawczą w pliku `ai-gemini.md` (rozumienie intencji, zakres prac, koncepcja, Kryteria Odbioru).
- Przed pisaniem kodu zapisz plan w `ai-gemini.md`, `TODO.md` i
