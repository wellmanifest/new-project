# Preprompt & Wytyczne Techniczne (ticket-040)

- **Tytuł Zadania**: Reduce managed Python complexity for downstream review
- **Utworzono**: 2026-08-08T14:45:30Z
...
- Specyfikacja modułu: `scripts/governance_check.py`,
  `scripts/decision_record.py`, downstream Koru run `31262565588`
