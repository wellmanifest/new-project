# Preprompt & Wytyczne Techniczne (ticket-123)

- **Tytuł Zadania**: Standardize multi-agent change leases and publication fencing
- **Utworzono**: 2026-08-25T20:01:02Z
...
- Specyfikacja modułu: `subprojects/change-lease/README.md`
- Powiązane kontrakty: `subprojects/ticket-lifecycle/README.md`,
  `subprojects/git-lifecycle/README.md`, `docs/WORKTREE_GUARD.md` oraz
  `wellmanifest/poa` execution lease.
