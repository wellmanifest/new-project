# Preprompt & Wytyczne Techniczne (ticket-051)

- **Tytuł Zadania**: Make adoption defaults portable and owned
- **Utworzono**: 2026-08-11T18:07:34Z
...
- Specyfikacja modułu: `project/ticket-051/README.md` oraz
  `project/ticket-051/intent.json`
