...
- [Changelog](CHANGELOG.md) - Added `script/readme.sh`, root `Makefile` documentation targets, generated README include menu, per-example README files, and CI documentation freshness checks. Added a generated examples artifacts index command that...
