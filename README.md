...
Generated by `script/readme.sh`. Do not edit this block by hand.
...
- [Architektura MVP](docs/architecture.md) - Projekt buduje pierwsza, kompletnie testowalna wersje systemu, ktory formalizuje ludzkie intencje, ustalenia i polecenia w jawny DSL. DSL ma byc czytelny dla czlowieka, jednoznaczny dla agentow AI i wykonalny przez ru...
- [Cross-Platform CLI](docs/cli-cross-platform.md) - The `packages/cli` entry points are designed to run on both Windows and Linux without shell-specific wiring.
- [JS/Node.js Code Generation](docs/code-generation.md) - This document describes the Phase 9 code-generation boundary implemented in `@office-dsl/codegen`. The package generates deterministic JS/Node.js artifacts only from an approved `intent-contract.dsl.v1` snapshot. It d...
- [Codex Sandbox Vitest Limitation](docs/codex-sandbox-vitest.md) - The default test suite is valid and passes outside the restricted Codex filesystem sandbox with:
- [Contract And Legal Document Renderers](docs/document-renderers.md) - This document defines the responsibilities and legal boundaries of the Intent/Contract document renderers implemented in `@office-dsl/document-renderer`. The renderers turn an approved or in-progress `intent-contract....
- [Documentation Index](docs/documentation-index.md) - Generated by `script/readme.sh`. Do not edit this file by hand.
- [Examples Artifacts Index](docs/examples-artifacts-index.md) - Generated by `script/readme.sh`. Do not edit this file by hand.
- [Examples Run Verification](docs/examples-run-verification.md) - This report records a full examples run after the package-boundary refactor and checks whether generated artifacts match the agreed project rules.
- [Office DSL To Intent/Contract Migration](docs/office-to-intent-contract-migration.md) - This note defines the compatibility path from the current executable `office.dsl.v1` MVP into the standalone canonical `intent-contract.dsl.v1` model.
- [Package Boundary Audit](docs/package-boundary-audit.md) - Status: resolved in the package-boundary milestone
- [Project Summary](docs/project-summary.md) - This document summarizes the current DSL Runtime repository state: what has been built, how the system works, how to verify it, and what remains open. It is based on the current code, examples, tests, `TODO.md`, and g...
- [Documentation Index](docs/README.md) - `README.md` - project purpose, current implementation status, target architecture, commands, and limitations. `TODO.md` - staged implementation roadmap with completion criteria. `docs/system-purpose-and-runtime-flow.m...
- [Audyt migracji research](docs/research-migration-audit.md) - Celem audytu bylo sprawdzenie, czy historyczne foldery badawcze zostaly przeniesione do `research/` bez utraty zawartosci. Stare foldery nie byly przywracane.
- [Python Semantic Verifier](docs/semantic-verifier.md) - This document describes the mock-safe Phase 10 semantic verifier boundary in `verifier/office_dsl_verifier` and the TypeScript runtime bridge in `@office-dsl/dsl-runtime`.
- [System Purpose And Runtime Flow](docs/system-purpose-and-runtime-flow.md) - The project is not meant to be only a small workflow language for office actions. Its long-term purpose is to formalize human intent before execution, document generation, code generation, or contract approval happens.
- [Test Generation From DSL](docs/test-generation.md) - This document describes the Phase 8 test generation boundary implemented in `@office-dsl/testgen`. The package turns an Intent/Contract DSL snapshot into typed test-generation inputs, generates deterministic test spec...

### Example Menu

- Office examples - run with `.\project.bat examples`
  - [01-read-only-report: Read-only unpaid invoices report](examples/01-read-only-report/README.md)
  - [02-clarification: Sales report with clarification](examples/02-clarification/README.md)
  - [03-email-drafts: Reminder drafts without sending](examples/03-email-drafts/README.md)
  - [04-confirmed-send: Confirmed mock reminder send](examples/04-confirmed-send/README.md)
  - [05-policy-denial: Unsafe command policy denial](examples/05-policy-denial/README.md)
  - [06-log-analysis: Failed invoice log analysis](examples/06-log-analysis/README.md)
- Chat examples - run with `.\project.bat examples-chat`
  - [01-short-agreement: Short agreement](examples-chat/01-short-agreement/README.md)
  - [02-long-negotiation-agreement: Long negotiation agreement](examples-chat/02-long-negotiation-agreement/README.md)
  - [03-short-conversation-cancelled: Short conversation cancelled](examples-chat/03-short-conversation-cancelled/README.md)
  - [04-long-negotiation-cancelled: Long negotiation cancelled](examples-chat/04-long-negotiation-cancelled/README.md)
- Recruitment examples - run with `.\project.bat examples-recruitment`
  - [01-multi-candidate: Multi-candidate recruitment](examples-recruitment/01-multi-candidate/README.md)
  - [02-single-candidate-agreement: Single candidate accepted recruitment](examples-recruitment/02-single-candidate-agreement/README.md)
  - [03-negotiated-two-candidates: Negotiated two-candidate recruitment](examples-recruitment/03-negotiated-two-candidates/README.md)
  - [04-ocr-candidate-cancelled: OCR candidate cancelled recruitment](examples-recruitment/04-ocr-candidate-cancelled/README.md)

Full generated indexes:

- [docs/documentation-index.md](docs/documentation-index.md)
- [docs/examples-artifacts-index.md](docs/examples-artifacts-index.md)
<!-- generated-docs:end -->
