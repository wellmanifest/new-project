...
DO RUN_AUTOMATED_DEV_TOOLS ("./project.sh" OR "project.bat")
DO READ_GENERATED_REPORTS_IN_PROJECT_DIR
...
ASSERT AGENT_ACTS_ON_TOOL_REPORTS_NOT_MANUAL_TOKEN_BURNING
```
